...
//
// The module path is styled as [stripes.Styles.Anchor], the version as
// [stripes.Styles.Number] (with the optional `/go.mod` suffix as
...
func renderGoSumLine(w io.Writer, line string, styles *stripes.Styles) {
